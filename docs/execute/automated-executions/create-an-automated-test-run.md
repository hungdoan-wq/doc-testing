...
- **Visual Testing**: Helps your application’s **UI looks correct**, not just functions correctly.  
    ...
    - For more information, please refer to the [Visual Testing document](/katalon-platform/analyze/analytics/visual-testing/visual-testing-overview) for more information.
