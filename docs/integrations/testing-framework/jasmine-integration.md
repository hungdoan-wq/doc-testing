...
:::info
The step-by-step instructions below use a Katalon [sample project](https://github.com/katalon-studio-samples/testops-report-sample-js/tree/master/jasmine) for illustration purposes.
:::
...
2. **Configure TestOps credentials & project**: 
    ...
    - ``reportFolder``: The directory where Jasmine will store test report JSON files (e.g., metadata, results, etc) after execution (default: `testops-report`).

    b. **Add reporter**: Create a file named ``config.js`` in your root directory and add the following content:
    ...
    ```
    <img src="https://tw-cdn.katalon.com/katalon-platform/integration/testing-framework/jasmine-step2.png" alt="Config Jasmine files" width="700"/>
...
<img src="https://tw-cdn.katalon.com/katalon-platform/integration/testing-framework/jasmine-uploaded.png" alt="Jasmine test report uploaded to testops" width="700"/>
