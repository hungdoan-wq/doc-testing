...
<ol xmlns="http://www.w3.org/1999/xhtml" className="ol"><li className="li"><a className="xref" href="/katalon-studio/manage-test-artifacts/manage-test-suites-in-katalon-studio#create-a-new-test-suite">Create a new test suite</a>.</li><li className="li">Plan test suite operation.     <ul className="ul"><li className="li"><a className="xref" href="/katalon-studio/execute-tests/execute-dynamic-test-suites-in-katalon-studio#modify-execution-information">Modify execution information</a>.</li><li className="li"><a className="xref" href="/katalon-studio/manage-test-artifacts/manage-test-suites-in-katalon-studio">Manage test case list</a>.</li></ul>   </li><li className="li">View <a className="xref" href="/katalon-studio/test-reports/view-test-reports/view-test-suite-and-test-suite-collection-reports-in-katalon-studio">Test suite reports</a>.     <p className="p"><span className="ph">Katalon Studio</span> logs test suite results in different formats and provides a complete account of the test suite process to help spot errors and reduce test case restructuring time.</p></li></ol> 
