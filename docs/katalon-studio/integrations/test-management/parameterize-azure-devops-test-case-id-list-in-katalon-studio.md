---
title: Parameterize Azure DevOps Test Case ID List in Katalon Studio
---
import useBaseUrl from '@docusaurus/useBaseUrl';


# Parameterize Azure DevOps Test Case ID List in Katalon Studio

<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can natively integrate with Azure DevOps   (ADO) to map ADO test cases to test cases in <span className="ph">Katalon Studio</span>, and   automatically submit test runs with results to ADO.</p> 

The following solution allows you to set custom test iteration IDs, enabling Katalon Studio to automatically map test iterations to their corresponding Azure DevOps test cases.
