...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={750} src={useBaseUrl("/91e68480-22b2-11ed-9930-0242fe3e4a3f/git-integration-workflow.png")} alt="Git integration workflow" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">To configure Git integration in <span className="ph">Katalon Studio</span>, see: <a className="xref" href="/katalon-studio/manage-projects/project-settings/git-integration/work-with-git-in-katalon-studio">Git integration in Katalon Studio</a>.</p> 
