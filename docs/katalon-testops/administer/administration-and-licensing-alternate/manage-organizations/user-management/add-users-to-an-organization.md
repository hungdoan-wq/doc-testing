---
title: Add a User to Organization & Assign Licenses
---
This document shows you how to add users to your organization and assign them licenses.
:::tip requirements
You must be assigned the **Account Admin** role to perform these actions.
:::
---
:::note 
  A user can only belong to **one Organization** but can work across Projects or other Organizations as needed.
:::
