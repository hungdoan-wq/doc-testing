...
<iframe src="https://demo.arcade.software/dmiDuPB4ZwW2tllC5LQ1?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Defects Activity Analysis Report" frameborder="0" loading="lazy" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" allow="clipboard-write" style={{ width: "100%", height: "400px", border: "none" }} >
</iframe>
