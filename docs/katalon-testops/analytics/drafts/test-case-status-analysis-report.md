...
**TestOps** detects and counts test cases with smart tags in the selected scope. See [Smart Tags](/katalon-platform/analyze/configure-smart-tags) to learn more about **TestOps Smart Tags**.
...
See [Probabilistic Flakiness Score](/katalon-platform/analyze/probabilistic-flakiness-score#calculations) to understand how **TestOps** calculates PFS to measure flakiness.
