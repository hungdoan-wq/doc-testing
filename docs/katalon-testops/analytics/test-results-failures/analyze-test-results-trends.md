...
This document explains how to use the test results analysis report to view results trends.
...
- Track test stability and performance across builds, sprints, or releases. See [Analyze execution history](docs/katalon-testops/analytics/test-case-activity/analyze-execution-history.md) to learn another use of this report.
...
It is often used as a drill-down destination from other reports (such as Common Automation Error Report) for failure analysis. See ... to learn more.

## Get started

<iframe src="https://demo.arcade.software/mDdAElA8R36ri6wAHXpm?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Test Results Analysis Report" frameborder="0" loading="lazy" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" allow="clipboard-write" style="width: 100%, height: 400px"></iframe>
