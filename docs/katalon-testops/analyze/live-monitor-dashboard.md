...
<iframe src="https://demo.arcade.software/Uhtw8bio2fwlemX2f8zH?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Live Monitor Dashboard" frameborder="0" loading="lazy" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" allow="clipboard-write" style={{ width: "100%", height: "400px", border: "none" }} ></iframe>
