...
1. **Test Case Health Analysis** - Current status distribution and latest outcomes for test cases within the selected sprint/release or time window. See more details at [Test Case Health Analysis Report](/katalon-platform/analyze/reports/test-case-status-analysis-report).
...
| **Review team performance and continuous quality trends** | **Analytics & Trends** <br/>→ Test Runs Analysis <br/>→ Test Case Health Analysis <br/>→ Defect Activity Analysis                                | Use **Analytics & Trends** for throughput and trendlines, then drill into **Runs**, **Case Status**, and **Defect Activity** reports for productivity and quality insights.                                                 |
