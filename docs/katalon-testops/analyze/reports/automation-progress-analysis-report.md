...
<iframe src="https://demo.arcade.software/iVubZYk0fuNVcosUOodX?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Automation Progress Analysis Report" frameborder="0" loading="lazy" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" allow="clipboard-write" style={{ width: "100%", height: "400px", border: "none" }} ></iframe>
