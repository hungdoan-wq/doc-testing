...
:::info
The step-by-step instructions below use a Katalon [sample project](https://github.com/katalon-studio-samples/testops-report-sample-js/tree/master/jest) for illustration purposes.
:::
...
2. **Configure TestOps credentials & project**: 
    ...
    <img src="https://tw-cdn.katalon.com/katalon-platform/integration/testing-framework/jest-step2.png" alt="Config Jest files" width="700"/>
...
<img src="https://tw-cdn.katalon.com/katalon-platform/integration/testing-framework/jest-uploaded.png" alt="Jest test report uploaded to testops" width="700"/>
