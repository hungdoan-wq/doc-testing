...
## Jan 14, 2026
### New feature
✨ **New: ZIP Repository Upload**: You can now upload Katalon Studio projects directly to TestOps as ZIP files.
- **Key capabilities**:
  - Upload `.zip` files containing valid Katalon Studio projects
  - Automatically extract and import test cases, test suites, test suite collections.
  - Create instant or scheduled automated test runs **using test suites from uploaded ZIP repositories**, and analyze the results in TestOps.

### Enhancement
Redesigned the **Test Result** detail page UI to make test result analysis and management easier and more efficient.
<img src="https://tw-cdn.katalon.com/katalon-platform/execute/test-results-new-jan15.png" alt="Test Result page new UI" width="700px" />

## Jan 7, 2026
**New Region Available: EU Multi-Tenant SaaS**: We’re excited to announce the launch of Katalon’s EU Multi-Tenant SaaS region, expanding our global footprint beyond the US for the first time.
- What’s new
  - **EU data residency** for organizations that require it
  - **Same Katalon experience**, now delivered from the EU
  - **Improved performance** for teams based in Europe
  - **Designed for compliance-driven industries** operating in the EU
European teams can now use Katalon with greater confidence around **data location, compliance, and performance**, without changing how they work.
This option is ideal for customers who **explicitly require EU data residency** due to regulatory, security, or regional performance needs.
...
<iframe src="https://demo.arcade.software/THUNf1ZTfKyznn2HgiQj?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Share an Analytics Dashboard View by Email" frameborder="0" loading="lazy" webkitallowfullscreen="true" mozallowfullscreen="true" allowfullscreen="true" allow="clipboard-write" style={{ width: "100%", height: "400px", border: "none" }}> </iframe>
...
- Added [`Automation Status`](/katalon-platform/create-tests/create-new-test-cases#create-test-case-manually) field to test cases to track their automation lifecycle. This helps QE teams assess automation coverage and generate actionable metrics.
- Added [`Priority`](/katalon-platform/create-tests/create-new-test-cases#create-test-case-manually) field to help teams assess and triage test case importance. This enables better planning and ensures critical test coverage is addressed first.
